      ...
      return GestureDetector(
        ...
        child: Card(
          ...
          child: Column(
            ...
            children: [
              Container(
                width: 366.0, // Fixed width
                height: 146.0, // Fixed height for the image
                child: Image.network(
                  product.imageUrl,
                  width: 366.0,
                  height: 160.0,
              ...
              Container(
                width: 366.0, // Fixed width to match the image
                height: 80.0, // Adjusted height for the text content
                padding: const EdgeInsets.all(8.0),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: 1,
        childAspectRatio:
            366 / 240, // Aspect ratio based on fixed width and height
      ),
      padding: EdgeInsets.symmetric(vertical: 8),
      itemCount: products.length,
      itemBuilder: (context, index) {
